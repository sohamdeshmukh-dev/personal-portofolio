    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto text-center relative z-10">
                ...
                <motion.p
                    className="text-2xl md:text-3xl dark:text-cool-gray text-gray-600 mb-2 font-light"
                ...
                <motion.p
                    className="text-2xl md:text-3xl dark:text-cool-gray/80 text-gray-500 mb-8 font-light"
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                {/* Get In Touch Button - Centered on Top */}
                <motion.div
