...
const Hero = () => {
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
            ...
            <GradientBlob color="blue" size={400} top="20%" left="70%" delay={1} />
            <GradientBlob color="blue" size={450} top="60%" left="5%" delay={2} />

            {/* Two-column layout: Text left, Profile Picture right */}
            <div className="max-w-7xl mx-auto relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        {/* Get In Touch Button and Social Links Row */}
                        <div className="space-y-6">
                            ...
                            >
                                <motion.a
                                    href="#contact"
                                    className="px-8 py-4 bg-[#004466] text-white font-semibold rounded-lg shadow-lg shadow-[#004466]/30 hover:shadow-[#004466]/50 transition-shadow duration-300"
                                    whileHover={{ scale: 1.05, boxShadow: '0 0 40px rgba(0, 68, 102, 0.5)' }}
                                    whileTap={{ scale: 0.95 }}
                                >
                                    Get In Touch
                                </motion.a>
                    ...
                    >
                        <motion.img
                            src="/profile.png"
                            alt="Soham Deshmukh"
                            className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover border-4 border-[#004466] shadow-lg shadow-[#004466]/30"
                            whileHover={{ scale: 1.05, boxShadow: '0 0 40px rgba(0, 68, 102, 0.5)' }}
