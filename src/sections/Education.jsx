                        ...
                        <div className="space-y-6">
                            ...
                            >
                                {education.tags.map((tag, idx) => (
                                    <motion.span
                                        key={idx}
                                        className="px-4 py-2 rounded-full text-sm font-medium bg-electric-blue/10 dark:text-white text-blue-600 border border-electric-blue/30 hover:bg-electric-blue/15 hover:border-electric-blue/50 hover:scale-105 transition-all"
